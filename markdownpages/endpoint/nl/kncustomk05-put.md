...
Deze connector wijzigt records in vrij bestand K05 via AfasKnCustomTable.XSKnCus.
...
#### Da
Wordt alleen bijgewerkt als het veld expliciet aanwezig is in de payload (IsPresent). Verplichting/zichtbaarheid blijft afhankelijk van AfasKnDateUseK05.
