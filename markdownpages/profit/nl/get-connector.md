...
Met de GetConnector [`MetaInfo`](../../apidoc/nl/Organisaties%20en%20personen#get-/MetaInfo) vraag je een lijst op van alle GetConnectoren in een omgeving. Je kunt deze GetConnector via een externe applicatie aanroepen.
Voordelen:
