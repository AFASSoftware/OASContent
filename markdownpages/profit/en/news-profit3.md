...
In UpdateConnector [FbConfrontation](../../apidoc/en/Mutaties#post-/connectors/FbConfrontation) it is mandatory to include a reference to the line in the financial mutation at the `FbGoodsReceivedLines` level. More details will be shared as soon as possible.
