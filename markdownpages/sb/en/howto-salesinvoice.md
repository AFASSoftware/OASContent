...
Endpoint: [Get Administrations](../../apidoc/sb/en/latest#get-/api/administrations)
...
Endpoint Organizations: [Get Organisations](../../apidoc/sb/en/latest#get-/api/persons) 
...
Endpoint: [Get Products 2.0](../../apidoc/sb/en/latest#get-/api/products)
...
Endpoint: [Get Addresses 1.0](../../apidoc/sb/en/latest#get-/api/addresses)
...
Endpoint: [Post Salesinvoice](../../apidoc/sb/en/latest#post-/api/salesinvoice)
...
> When offering this request, we recommend using the [Tracking Identifier](./change-tracking) to avoid duplicate entries.
