...
Endpoint: [Get organisation](../../apidoc/sb/nl/latest#get-/api/organisations)

Met deze request haal je de organisaties op. Als een gewenste organisatie al bestaat kan het `Id` gebruikt worden.

Als de gewenste organisatie niet bestaat moet deze worden aangemaakt. Dit kan met de [Post organisation](#post-organisation).
...
Endpoint: [Put organisation](../../apidoc/sb/nl/latest#put-/api/organisation)
...
Endpoint: [Post organisation](../../apidoc/sb/nl/latest#post-/api/organisation)
...
Endpoint: [Post person](../../apidoc/sb/nl/latest#post-/api/person)
...
Endpoint: [Get persons](../../apidoc/sb/nl/latest#get-/api/persons)
