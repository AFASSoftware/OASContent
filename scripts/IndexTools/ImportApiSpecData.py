...
# Path to the OpenApiSpecs directory (already unpacked)
openapi_specs_path = Path(__file__).resolve().parents[2] / 'OpenApiSpecs'
...
if __name__ == '__main__':
    # Read OpenAPI files from the already unpacked directory
    jsonl_data = read_openapi_files(openapi_specs_path)
